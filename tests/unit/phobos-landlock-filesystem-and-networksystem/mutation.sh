...
#
#   tests/unit/phobos-landlock-filesystem-and-networksystem/mutation.sh            score plus the surviving mutants
#   tests/unit/phobos-landlock-filesystem-and-networksystem/mutation.sh --quiet    score and survivor count, no breakdown
#
...
mutators:
  - cxx_all
includePaths:
  - core/phobos-landlock-filesystem-and-networksystem/phobos-landlock-filesystem-and-networksystem.*
excludePaths:
  - tests/.*
