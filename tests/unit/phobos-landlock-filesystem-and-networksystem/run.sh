...
#
#   tests/unit/phobos-landlock-filesystem-and-networksystem/run.sh                  build and run
#   tests/unit/phobos-landlock-filesystem-and-networksystem/run.sh --coverage       build instrumented, run, print the summary
#   tests/unit/phobos-landlock-filesystem-and-networksystem/run.sh --coverage DIR   the same, but build in DIR and leave it
