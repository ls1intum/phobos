...
#
#   tests/unit/phobos-seccomp-networksystem/seccomp_networksystem_run.sh               build with -Werror and run
#   tests/unit/phobos-seccomp-networksystem/seccomp_networksystem_run.sh --coverage    build instrumented, run, hold lines to 100 %
#
